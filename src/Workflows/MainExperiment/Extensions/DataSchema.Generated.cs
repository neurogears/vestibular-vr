...
namespace DataSchema
{
    ...
    public partial class StimulusProtocol
    {
        ...
        private StimulusProtocolMode _mode = DataSchema.StimulusProtocolMode.ClosedLoop;
        ...
        /// <summary>
        /// The mode of the visual stimulus: closed-loop or open-loop.
        /// </summary>
        [System.Xml.Serialization.XmlIgnoreAttribute()]
        [YamlDotNet.Serialization.YamlMemberAttribute(Alias="mode")]
        [System.ComponentModel.DescriptionAttribute("The mode of the visual stimulus: closed-loop or open-loop.")]
        public StimulusProtocolMode Mode
        {
            get
            {
                return _mode;
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Bonsai.Sgen", "0.3.0.0 (YamlDotNet v13.0.0.0)")]
    public enum StimulusProtocolMode
    {
    
        [YamlDotNet.Serialization.YamlMemberAttribute(Alias="closed-loop")]
        ClosedLoop = 0,
    
        [YamlDotNet.Serialization.YamlMemberAttribute(Alias="open-loop")]
        OpenLoop = 1,
    }
    ...
    public enum StimulusProtocolType
    {
        ...
        [YamlDotNet.Serialization.YamlMemberAttribute(Alias="corridor")]
        Corridor = 3,
    }
