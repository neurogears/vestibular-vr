...
ISR(PORTA_INT0_vect, ISR_NAKED)
{
	...
	//{
		...
		//{			
			...
			//
			//app_regs.REG_IN_STATE = B_EMERGENCY_INPUT_CHANGED | (app_regs.REG_IN_STATE & B_ENCODER_A_PHASE) | B_EMERGENCY_INPUT;			
	...
	//{
		...
		//{
			...
			//
			//app_regs.REG_IN_STATE = B_EMERGENCY_INPUT_CHANGED | (app_regs.REG_IN_STATE & B_ENCODER_A_PHASE);
			//core_func_send_event(ADD_REG_IN_STATE, true);
		//}
	//}
...
ISR(PORTA_INT1_vect, ISR_NAKED)
{
	...
	//{
		...
		//{
			...
			//
			//app_regs.REG_IN_STATE = B_ENCODER_A_PHASE_CHANGED | (app_regs.REG_IN_STATE & B_EMERGENCY_INPUT) | B_ENCODER_A_PHASE;			
			//core_func_send_event(ADD_REG_IN_STATE, true);
		//}
	//}
	//else
	//{
		...
		//{
			...
			//
			//app_regs.REG_IN_STATE = B_ENCODER_A_PHASE_CHANGED | (app_regs.REG_IN_STATE & B_EMERGENCY_INPUT);
			//core_func_send_event(ADD_REG_IN_STATE, true);
		//}
	//}
